    ...
    <div class="row">
        <div class="col-lg-3">
            ...
            <div class="list-group">
                ...
                <a href="{{url('/hoodies')}}" class="btn btn-primary">Back to All Products</a>
            </div>
        </div>
        <div class="col-lg-9">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <div class="add-to-cart-button">
                        <p>
                            <a class="btn btn-danger" data-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Delete This Hoodie</a>
                        </p>
                        <div class="row">
                            <div class="col">
                                <div class="collapse multi-collapse" id="multiCollapseExample1">
                                        <div class="card card-body">
                                            Are You Sure? To Delete This Hoodie?
                                            <div class="conform-btn">
                                                {!! Form::open(['route'=>['hoodies.destroy',$hoodies->id],'method'=>'DELETE']) !!}
